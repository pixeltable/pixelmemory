...
# pixelmemory release script

SCRIPT_DIR="$(dirname "$0")"
PROJECT_ROOT="$(readlink -f "$SCRIPT_DIR/..")"

echo -e "\n============= Running pixelmemory release script.\n"
...
if [ "$(git remote get-url home)" != 'https://github.com/pixeltable/pixelmemory' ]; then
...
gh release create "v$VERSION" --generate-notes --repo pixeltable/pixelmemory
open "https://github.com/pixeltable/pixelmemory/releases/tag/v$VERSION"
